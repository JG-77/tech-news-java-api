...
public class PostController {
    ...
    @GetMapping("/api/posts") //gets all posts
    ...
    @GetMapping("/api/posts/{id}") //gets one single post
    ...
    //updates post that have already been made
    ...
    //every post can be up-voted, we have to track the votes cast for each post
